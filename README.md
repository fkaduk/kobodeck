...
- are ok with mixing ebooks and with articles in the UI, if want to separate bookmars and other ebooks, check out [kobeck](TODO)
...
TODO: make sure these instructions are idempotent
